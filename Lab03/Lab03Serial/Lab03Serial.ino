...
void loop() {
    ...
    // Separamos los datos de humedad y temperatura, los cuales vienen separados por una coma en el mensaje recibido
    ...
    if (now - lastMsg > 1000) {
      ...
      // Convertimos las variables de String a cadenas de caracteres, ya que la función publish() de la librería PubSubClient.h solo acepta cadenas de caracteres
